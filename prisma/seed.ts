//para executar arquivos em ts, usa-se npm install -D ts-node@10.9.2 (-D diz que apenas servirá para este projeto)

//Para rodar (enviar os dados deste arquivo) para o BD, basta ir no package.json e adicionar prima{ "seed": "ts-node ./prisma/sees.ts"}
//E dps rodar no terminal npx prisma db seed
